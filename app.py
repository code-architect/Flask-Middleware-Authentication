...
app.add_url_rule('/account/sign-in', view_func=FlaskAccount.sign_in, endpoint='account_sign-in', methods=['GET'])
app.add_url_rule('/account/sign-out', view_func=FlaskAccount.sign_out, endpoint='account_sign-out', methods=['GET'])
